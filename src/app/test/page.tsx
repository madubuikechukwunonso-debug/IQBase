...
export default function TestPage() {
  const sessionData = useSession()                    // ← safe pattern from your original working code
  ...
  // RELIABLE REDIRECT — waits until session is fully loaded
  useEffect(() => {
  ...
  // Show loading while NextAuth checks login status
  if (status === "loading") {
    return (
