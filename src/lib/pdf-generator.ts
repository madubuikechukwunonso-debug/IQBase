...
export async function generatePremiumPDF(
  ...
  // SCORE BOX
  y = 520;
  page.drawRectangle({ x: 50, y: y - 10, width: 495, height: 110, borderColor: rgb(0.55, 0.2, 0.9), borderWidth: 6, color: rgb(1, 1, 1) });
  ...
  for (let i = 0; i < questions.length; i++) {
    ...
    y -= 110;   // ← MAXIMUM spacing to prevent any overlap
  }
